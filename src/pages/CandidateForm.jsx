...
import {
  FONTES,
  SEXOS,
  DISPONIBILIDADES_TRABALHO,
  DISPONIBILIDADES_TREINAMENTO,
  DISPONIBILIDADES_JORNADA,
} from '../lib/candidato'
...
export default function CandidateForm() {
  ...
  async function handleSubmit(e) {
    ...
    if (form.nome_indicador === '' && form.fonte === 'Indicação') {
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input name="rg" required className="field-input" value={form.rg} onChange={handleChange} />
              </div>
              <div>
                <label className="field-label">CPF</label>
                <input name="cpf" required className="field-input" value={form.cpf} onChange={handleChange} />
              </div>
            </div>
            <div>
          ...
          <section className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                {DISPONIBILIDADES_TRABALHO.map((o) => (
            ...
            <div>
              ...
              >
                ...
                {DISPONIBILIDADES_TREINAMENTO.map((o) => (
                  <option key={o} value={o}>
                    {o}
                  </option>
                ))}
            ...
            <div>
              ...
              >
                ...
                {DISPONIBILIDADES_JORNADA.map((o) => (
                  <option key={o} value={o}>
                    {o}
                  </option>
                ))}
